...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return {
        a: common_vendor.unref(utils_sytem.getstatusBarHeight)() + "px",
        ...
        d: common_vendor.unref(utils_sytem.getTitleBarHeight)() + "px",
        e: common_vendor.unref(utils_sytem.getnavBarHright)() + "px"
      };
    };
  }
};
